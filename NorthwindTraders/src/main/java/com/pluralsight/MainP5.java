...
// "jdbc:mysql://127.0.0.1:3306/northwind"; URL
...
public class MainP5 {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (choice) {
                case "1":
                    displayAllProducts(dataSource); // Call method to display products
                    break;
                case "2":
                    displayAllCustomers(dataSource); // Call method to display customers
                    break;
                case "3":
                    displayCategoriesAndProductsBySelection(dataSource);
                case "0":
    ...
    private static void displayCategoriesAndProductsBySelection(DataSource dataSource) {
        System.out.println("\n--- All Categories ---");
        ...
        displayProductsByCategoryId(selectedCategoryId, dataSource);
    }

    private static void displayProductsByCategoryId(int categoryId, DataSource dataSource) {
